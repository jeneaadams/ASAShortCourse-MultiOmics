...
localPath = "/Users/adamsj8/Library/CloudStorage/Box-Box/Zhang Lab/ASAShortCourse-MultiOmics/Lecture\ 3/"
...
showPCA(results,n_joint=1,n_indiv=c(1,1,1),Colors=Colors) #exactly which features are contirbuting to clinical outcomes? 
```
...
```{r}
pcGmmBicTwo = mclustBIC(stackedPcFactors[,1:2],G = 2) #fixed G =2
#summary(pcGmmBicTwo)
